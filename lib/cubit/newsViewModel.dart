...
class Newsviewmodel extends Cubit<Newssates> {
  int selectedIndex = 0;
  ...
  Newsviewmodel({required this.newsRemoteRepository})
      : super(NewsLoadingState());
  // {
  //   apimanager = Apimanager();
  //   newsRemoteDatasource = NewsRemotedatasourceimpl(apimanager: apimanager);
  //   newsRemoteRepository =
  //       NewsRemoteRepositoryimpl(newsRemoteDatasource: newsRemoteDatasource);
  // }
